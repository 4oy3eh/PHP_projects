...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3 comments-section">
            ...
            <!-- comment form -->
            <form class="clearfix" action="/form/postcomment.php" method="post">
...
<?php endif;?>
            ...
            $countcomments = $mysql->query("SELECT count(*) as qwe FROM `comments`");
            $countcomments = $countcomments->fetch_assoc();
            ...
            <h2><span id="comments_count"><?php echo($countcomments[qwe])?></span> Comment(s)</h2>
            <hr>
            <!-- comments wrapper -->
            <?php for($i=1;$i<=$countcomments[qwe];$i++):
            $fetchcomments = $comments->fetch_assoc();
            ?>
            <div id="comments-wrapper">
                <div class="comment clearfix">
                    <img src="profile.png" alt="" class="profile_pic">
                    <div class="comment-details">
                        <span class="comment-name"><?php echo($fetchcomments[email])?></span>
                        <span class="comment-date"><?php echo($fetchcomments[date])?></span>
                        <p><?php echo($fetchcomments[comment])?></p>
                    </div>
                </div>
            </div>
            <?php endfor; ?>
